...
var questions = [{
    ...
    answerList: ["White", "Blue", "Brown", "Black", "I have no idea, I wasn't a history major!"],
    answer: 0
},{
    question: "What color is an Akhal-Teke when it is shining gold?",
    answerList: ["Clear", "Gold", "Green", "Akhal-Teke is not a horse", "Tan"],
    answer: 1
},{
    question: "How many inches is one hand when measuring a horse's height?",
    answerList: ["dude, it's a hand", "12 inches", "4 inches", "2 feet"],
    answer: 2
},{
    question: "What's the heighest a horse has jumped?",
    answerList: ["1 foot", "4 feet", "higher than Godzilla", "7'8"],
    answer: 3
},{
    question: "Was the black stallion black?",
    answerList: ["yes", "no he's a dark bay", "I don't know, I didn't see the movie", "that's racist"],
    answer: 1
},{
    question: "Where does the term 'warmblood' come from?",
    answerList: ["they would warm up the blood before drinking it", "it's a mixture between cold blood and hot blood horses (draft meets thoroughbred", "it's an interal heater for horses", "what?"],
    answer: 1
},{
    question: "What's the difference between Equitation and Hunt Seat?",
    answerList: ["nothing, you dumbass", "Hunt Seat is for hunting foxes, and equitation is for watching TV", "Equitation is judged on the rider and hunt seat is judged on the horse", "you can't buy Eq"],
    answer: 3
}];
